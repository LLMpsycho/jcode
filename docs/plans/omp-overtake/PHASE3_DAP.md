...
| Windows debugger process-tree containment | Current Windows debugger launch and attach fail closed before reservation or process creation; descendant containment is not yet implemented. | Add owned descendant-tree containment such as a Windows Job Object before enabling real debugger launch or reverse process requests on Windows. |
