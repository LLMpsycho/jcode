...
#[path = "ui_messages/overnight_progress.rs"]
mod overnight_progress;
use overnight_progress::{
    compact_run_id, format_overnight_task_counts, push_wrapped_kv_line,
    render_overnight_progress_line,
};
