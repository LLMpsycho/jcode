...
impl App {
    pub(super) fn command_help(&self, topic: &str) -> Option<String> {
        ...
        let help = match topic.as_str() {
            ...
            "advisor" => {
                "/advisor\nChoose the advisor model and reasoning effort from your available signed-in providers. Selection affects this session's advisor and leaves the main model unchanged.\n\n/advisor model <name>\nChoose the model and effort for a named advisor.\n\n/advisor status [name]\nShow the active advisor selection.\n\n/advisor inspect [name]\nInspect advisor notes and activity.\n\n/advisor inherit [name]\nFollow the main model and effort.\n\n/advisor on|off [name]\nEnable or disable the advisor for this session.\n\n/advisor ack|dismiss <note-id> [name]\nHandle a note for the selected advisor."
            }
            "swarm-prompt" => {
